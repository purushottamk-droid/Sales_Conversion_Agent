...
export default function MarketingHero({ onRun, disabled }) {
  return (
    <section className="text-center mb-14">
      ...
      <p className="text-base text-[#55698c] dark:text-[#8ca0c2] max-w-[560px] mx-auto mb-[30px] leading-relaxed">
        Pull campaign performance &amp; audience engagement across channels, then reason over
        sentiment and conversion drop-off — and act on it automatically.
      </p>
      ...
      <div className="flex gap-2.5 justify-center flex-wrap mb-3.5">
        ...
        >
          ...
          {disabled ? 'Running...' : 'Run Marketing Workflow'}
        </button>
      </div>
    </section>
  );
