...
// Dedicated node component for the Marketing Agent pipeline.
// Intentionally NOT shared with Sales/NPS PipelineNode — kept independent
// so styling/behavior changes here never ripple into other agents.
export default function MarketingPipelineNode({ number, title, description, state, detail, children }) {
  return (
    <div
