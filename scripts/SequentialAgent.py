...
# from google.adk.agents.run_config import ResumabilityConfig
...
# Wrap root_agent in resumable App
# This replaces the App defined inside decision_action_agent/agent.py
# which was incorrectly wrapping only Agent 4
app = App(
    name="sales_rep_pipeline_app",
